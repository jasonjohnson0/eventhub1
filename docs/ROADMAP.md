...
Last verified: 2026-09-14, against commit `eda1d0e` (spec 02 done) + this pass's timezone-display work. Specs for everything below that isn't Live: `docs/specs/`. Overnight mailbox: `TEAMWORK.md` (repo root).
